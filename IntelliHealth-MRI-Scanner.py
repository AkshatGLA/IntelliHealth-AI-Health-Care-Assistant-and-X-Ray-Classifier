...
# Load models
alz_model = load_model(r'C:\Projects\Intellihealth\models\alz_classifier.h5')
tumor_model = load_model(r'C:\Projects\Intellihealth\models\braintumor_new (1).h5')
# pneumonia_model = pickle.load(open(r"C:\GEN AI-PPROJECT\RPC\pneumonia_model.sav", 'rb'))
pneumonia_model=load_model(r'C:\Projects\Intellihealth\models\pneumonia_model.h5')
############  Welcome Message  ############
import time
st.set_page_config(
    page_title="Intellihealth-MRI-Scanner",
    page_icon=r"C:\Projects\Intellihealth\images\icon.jpg",
...
def alzheimer():
    ...
    with col2:
        memory = Image.open(r'C:\Projects\Intellihealth\images\m3.jpg')
...
def tumor():
    ...
    with col2:
        brain_tumor = Image.open(r'C:\Projects\Intellihealth\images\brain.jpg')
...
def pneumonia():
    ...
    with col2:
        lungs = Image.open(r'C:\Projects\Intellihealth\images\lungs1.jpg')
